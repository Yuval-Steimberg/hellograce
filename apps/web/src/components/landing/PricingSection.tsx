...
const INCLUDED = [
  ...
  "Personal weekly Grace report with one next focus",
  "Adaptive daily meal, hydration & movement plan",
  "Injection-cycle patterns based on your own symptoms",
  "Doctor-ready report you can copy before an appointment",
