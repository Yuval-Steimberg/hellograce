    ...
    switch (matchedCategory) {
      case 'protein_goal': {
        ...
        if (!g || g <= 0) {
          ...
          return {
            text: `Your personalized target isn't set yet, but research suggests 1.2-1.6g of protein per kg of body weight daily on GLP-1s. Set your exact target at grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings.`,
      ...
      case 'calorie_goal': {
        ...
        if (!k || k <= 0) {
          return {
            text: `Your personalized calorie target isn't set yet. You can configure it at grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings.`,
      ...
      case 'weight_goal': {
        ...
        if (!w || w <= 0) {
          return {
            text: `I don't have your goal weight on file yet. You can set it at grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings.`,
      ...
      case 'start_date': {
        ...
        if (!d) {
          ...
          return {
            text: `I don't have your GLP-1 start date on file yet. You can set it at grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings.`,
            category: 'start_date',
          };
        }
      ...
      case 'week_number': {
        ...
        if (!d) {
          return {
            text: `I don't have your GLP-1 start date on file yet, so I can't pin the week number. Set it at grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings.`,
      ...
      case 'medication': {
        ...
        if (!med || med.trim().length === 0) {
          return {
            text: `I don't have your medication on file yet. You can set it at grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings.`,
            category: 'medication',
          };
        }
      ...
      case 'injection_day': {
        ...
        if (!day || day.trim().length === 0) {
          ...
          return {
            text: `I don't have your injection day on file yet. You can set it at grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings.`,
      ...
      case 'starting_weight': {
        ...
        if (!sw || sw <= 0) {
          return {
            text: `I don't have your starting weight on file. You can set it at https://grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings — or send me "set my starting weight to ___ lbs".`,
      ...
      case 'weight_progress': {
        ...
        if (!sw || sw <= 0) {
          return {
            text: `I'd love to tell you, but your starting weight isn't on file yet. Set it at https://grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings and I can calculate your total loss.`,
      ...
      case 'age': {
        ...
        if (!a || a <= 0) {
          return {
            text: `I don't have your age on file. You can set it at grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings.`,
            category: 'age',
          };
        }
        return {
      ...
      case 'is_calorie_enough': {
        ...
        if (parts.length === 0) {
          return {
            text: `It depends on your weight, goal, and activity level. Set your personalized calorie target at grace-admin-git-claude-gemini-c34cfe-yuval-steimbergs-projects.vercel.app/settings and I can compare. Want me to walk through the math?`,
